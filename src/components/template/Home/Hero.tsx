...
const HeroSection: React.FC = () => {
  return (
    <section className=" flex lg:flex-row  flex-col  lg:justify-evenly self-stretch py-16 w-full max-md:max-w-full h-[600px] px-[20px] lg:px-[0px] ">
     <div className="h-[600px] max-w-[720px]"> 
      <h2 className="text-3xl font-semibold tracking-wider text-teal-500 max-md:text-xl">
         Kindergarten Program
       </h2>
       <h1 className="self-stretch mt-4 text-7xl font-bold text-black leading-[88px] tracking-[2.1px] max-lg:text-5xl max-lg:leading-[70px] max-md:text-4xl max-md:leading-[56px]">
       ...
       <button className="px-10 py-4 mt-12 text-white bg-orange-400 rounded-[94px] max-lg:px-10 max-lg:py-7 max-md:px-5 max-md:py-4 max-md:mt-6">
         Apply Now
       </button></div>
     <div className="h-[600px] flex content-center justify-center items-center -mt-[200px] lg:mt-0"> <img
       loading="lazy"
       ...
       className="object-contain grow w-full aspect-[1.18] max-md:mt-10 max-md:max-w-full h-[600px]"
     /></div>
    </section>
  );
};
...
{/* <div className="self-center mt-5   max-md:mt-10 w-screen lg:max-w-[1600px] md:max-w-[700px] sm:max-w-[390px] px-[20px]">
