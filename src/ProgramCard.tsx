...
const ProgramCard: React.FC<ProgramCardProps> = ({
  ...
  const buttonClasses = isHighlighted
    ? "px-16 py-8 mt-10 max-w-full text-2xl tracking-wide leading-none text-center text-white border-2 border-white border-solid rounded-[61px] w-[268px] max-md:px-5"
    : "px-16 pt-6 pb-10 mt-20 max-w-full text-2xl tracking-wide leading-none text-center text-black border border-orange-400 border-solid rounded-[61px] w-[268px] max-md:px-5 max-md:mt-10";
  ...
  return (
    <div className={cardClasses}>
      ...
      <div className={contentClasses}>
        <div className="flex flex-col justify-center items-center px-9 bg-orange-50 rounded-full h-[187px] w-[187px] max-md:px-5">
          <img
            loading="lazy"
            src={imageSrc}
            alt={`${title} icon`}
        ...
        <h3
          className={`mt-9 text-3xl font-semibold tracking-wider leading-none ${titleClasses}`}
        >
          {title}
        </h3>
        <p
