      ...
      <div className="flex gap-5 max-md:flex-col">
        <div className="flex flex-col w-[55%] justify-center items-center max-md:ml-0 max-md:w-full">
          <img
            ...
            className="object-contain w-full aspect-[1.0] max-md:mt-5 max-md:max-w-full"
          />
        </div>
        <div className="flex flex-col   w-[45%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col items-start mt-0 w-full max-md:mt-0 max-md:max-w-full">
            <h2 className="text-5xl font-bold tracking-wider leading-none text-black max-md:text-4xl">
              Our Programs
            </h2>
            <p className="self-stretch mt-0 text-2xl tracking-wider leading-10 text-black max-md:mt-10 max-md:max-w-full">
